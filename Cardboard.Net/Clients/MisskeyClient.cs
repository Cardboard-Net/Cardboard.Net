...
{
    public MisskeyClient(MisskeyApiClient apiClient, ILogger<MisskeyClient> logger) : base(logger)
    {
    ...
    public override async Task<User?> GetUserAsync(string userId)
    ...
    /// <returns>User</returns>
    public override async Task<User?> GetUserAsync(string username, string? host = null)
    ...
    public override async Task FollowUserAsync(string userId, bool withReplies = false)
    ...
    public override async Task SuspendUserAsync(string userId, bool selfsuspend = false)
    ...
    public override async Task UnsuspendUserAsync(string userId)
    ...
    public override async Task SilenceUserAsync(string userId, bool selfsilence = false)
    ...
    public override async Task UnsilenceUserAsync(string userId)
        => await this.ApiClient.SilenceUserAsync(userId);
    ...
    /// <returns></returns>
    public override async Task<Note> GetNoteAsync(string noteId)
    ...
    public override async Task<Note> CreateNoteAsync(string text, string? contentWarning = null, VisibilityType visibility = VisibilityType.Public, bool isLocal = false, AcceptanceType acceptance = AcceptanceType.NonSensitiveOnly) 
    ...
    public override async Task DeleteNoteAsync(string noteId)
    ...
    public override async Task CreateReactAsync(string noteId, string reaction)
    ...
    public override async Task DeleteReactAsync(string noteId)
    ...
    public override async Task<Emoji> GetEmojiAsync(string name)
    ...
    public override async Task<DriveUsage> GetDriveUsageAsync()
    ...
    public override async Task<DriveFile> GetDriveFileAsync(string fileId)
    ...
    /// <returns>DriveFile</returns>
    public override async Task<DriveFile> GetDriveFileAsync(Uri url)
    ...
    public override async Task<DriveFolder> GetDriveFolderAsync(string folderId)
    ...
    public override async Task<IReadOnlyList<DriveFolder>> GetDriveFoldersAsync(int limit = 10, string? folderId = null, string searchQuery = "")
    ...
    /// <returns></returns>
    [Experimental("FoldersExperiment")]
    public override async Task<IReadOnlyList<DriveFolder>> GetDriveFoldersAsync(string beforeId, int limit = 10, string? folderId = null, string searchQuery = "")
    ...
    /// <returns></returns>
    [Experimental("FoldersExperiment")]
    public override async Task<IReadOnlyList<DriveFolder>> GetDriveFilesAsync(string beforeId, string untilId, int limit = 10, string? folderId = null, string searchQuery = "")
    ...
    /// <returns>DriveFolder</returns>
    public override async Task<DriveFolder> FindDriveFolderAsync(string name, string? parentId = null)
    ...
    /// <returns></returns>
    public override async Task<DriveFolder> CreateDriveFolderAsync(string name, string? parentId = null)
    ...
    public override async Task DeleteDriveFolderAsync(string folderId)
